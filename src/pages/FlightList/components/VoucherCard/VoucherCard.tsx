...
const VoucherCard = ({
  ...
  return (
    <div
      className={`voucher-card ml-1 grid gap-5 w-[250px] flex-grow-0 flex-shrink-0 md:h-[174px] rounded-[20px] shadow-[0_4px_4px_0_rgba(0,0,0,0.25)] border-[20px] border-transparent ${className}`}
    >
      ...
      <div className="flex voucher-code h-12 rounded-[10px] border-dashed border-black border-[1px] bg-gray-100 items-center px-[15px] justify-between">
        ...
        <a href=" " className="text-blue-700" onClick={handleCopyToClipboard}>
          {isCopied ? 'Copied!' : 'Copy'}
        </a>
      </div>
    </div>
    // <div
    //   className={`lg:top-40 md:top-[173px]  max-w-full lg:mr-3 md:mr-2 overflow-x-hidden h-[190px] ${className}`}
    // >
