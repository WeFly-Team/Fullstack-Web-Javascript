  ...
  return (
    <div className=" md:p-10 md:grid grid-cols-2 items-center lg:grid justify-items-center">
      ...
      <div className=" gap-4 p-4  grid grid-cols-2 md:grid-cols-3">
        <div>
          <img
            src="https://i.ibb.co/PDn14sk/pexels-tom-mal-k-3408353-1.png"
          ...
          <div className="p-2 flex items-center justify-between">
            ...
            <img
              className="w-8"
              src="https://i.ibb.co/2WCS7GV/Frame-81.png"
              alt="Frame-81"
            ></img>
          </div>
        </div>
        <div>
          <img
            src="https://i.ibb.co/GJPTSDZ/pexels-deva-darshan-2389473-1-1.png"
        ...
        <div>
          <img
            src="https://i.ibb.co/bXknn2g/pexels-ashok-j-kshetri-4032145-1.png"
        ...
        <div>
          <img
            src="https://i.ibb.co/j8TKbvK/pexels-mudassir-ali-1878293-1.png"
